define(['app'], function (app) {
	app.controller('HardwareController', [ '$scope', '$rootScope', '$location', '$http', '$interval', function($scope,$rootScope,$location,$http,$interval) {
		...
		UpdateHardware= function(idx,Mode1,Mode2,Mode3,Mode4,Mode5)
		{
			...
			if ((text.indexOf("TE923") >= 0)||(text.indexOf("Volcraft") >= 0)||(text.indexOf("1-Wire") >= 0)||(text.indexOf("BMP085") >= 0)||(text.indexOf("Dummy") >= 0)||(text.indexOf("PiFace") >= 0)||(text.indexOf("Motherboard") >= 0)||(text.indexOf("Sonos") >= 0)||(text.indexOf("Evohome") >= 0 && text.indexOf("script") >= 0))
			{
				$.ajax({
		...
		AddHardware = function()
		{
			...
			if ((text.indexOf("TE923") >= 0)||(text.indexOf("Volcraft") >= 0)||(text.indexOf("1-Wire") >= 0)||(text.indexOf("BMP085") >= 0)||(text.indexOf("Dummy") >= 0)||(text.indexOf("PiFace") >= 0)||(text.indexOf("GPIO") >= 0)||(text.indexOf("Sonos") >= 0))
			{
				$.ajax({
			 ...
			 success: function(data) {
			  ...
			  if (typeof data.result != 'undefined') {
				$.each(data.result, function(i,item){
					...
					else if ((item.Type == 15)||(item.Type == 23)||(item.Type == 26)||(item.Type == 27)||(HwTypeStr.indexOf("Sonos") >= 0))
					{
						SerialName="";
					}
			...
			$("#hardwaretable tbody").on( 'click', 'tr', function () {
				if ( $(this).hasClass('row_selected') ) {
					...
					if ( anSelected.length !== 0 ) {
						...
						if ((data["Type"].indexOf("TE923") >= 0)||(data["Type"].indexOf("Volcraft") >= 0)||(data["Type"].indexOf("1-Wire") >= 0)||(data["Type"].indexOf("BMP085") >= 0)||(data["Type"].indexOf("Dummy") >= 0) ||(data["Type"].indexOf("PiFace") >= 0) ||(data["Type"].indexOf("Sonos") >= 0))
						{
							//nothing to be set
						}
